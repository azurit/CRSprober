...
tests = [
	{"version": "4.18.0 or newer", "payloads": [{"headers": {"Cookie": "a=;rmt-dump"}, "trigger": 1}]},
	{"version": "4.17.1", "payloads": [{"headers": {"Cookie": "a=\\{}="}, "trigger": 0}, {"get": "/java.net.JarURLConnection", "trigger": 1}]},
